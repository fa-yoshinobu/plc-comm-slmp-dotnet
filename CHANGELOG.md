...
- Library: Empty hexadecimal X/Y addresses and link-direct addresses wider than the 24-bit wire field are rejected before transport instead of being accepted or truncated.
