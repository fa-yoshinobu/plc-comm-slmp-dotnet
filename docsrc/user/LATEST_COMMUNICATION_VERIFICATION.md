...
- fully verified families across the current retained compatibility summary: `iQ-R` and `iQ-L`
- mixed or profile-limited families in the retained summary: `MELSEC-Q`, `MELSEC-L`, `iQ-F`, and third-party MC-compatible endpoints
...
- keep frame type and compatibility mode explicit for every connection
