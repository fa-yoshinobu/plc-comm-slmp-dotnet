...
public static class SlmpPlcProfiles
{
    ...
    private static string? GetBaseProfile(SlmpPlcProfile profile)
        => profile switch
        {
            ...
            SlmpPlcProfile.MxRRj71En71 => "melsec:mx-r",
    ...
    public static SlmpPlcProfile Parse(string? text)
    {
        ...
        return normalized switch
        {
            ...
            "melsec:mx-r:rj71en71" => SlmpPlcProfile.MxRRj71En71,
    ...
    public static string ToCanonicalString(SlmpPlcProfile profile)
        => profile switch
        {
            ...
            SlmpPlcProfile.MxRRj71En71 => "melsec:mx-r:rj71en71",
    ...
    public static SlmpPlcProfileDefaults Resolve(SlmpPlcProfile profile)
        => profile switch
        {
            ...
            SlmpPlcProfile.MxR => new(
                ...
                SlmpPlcProfile.MxR,
                SlmpPlcProfile.MxR),
            SlmpPlcProfile.MxRRj71En71 => new(
                SlmpFrameType.Frame4E,
                SlmpCompatibilityMode.Iqr,
                SlmpPlcProfile.MxR,
                SlmpPlcProfile.MxRRj71En71),
